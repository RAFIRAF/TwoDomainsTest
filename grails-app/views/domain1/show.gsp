...
<html>
    ...
    <body>
        ...
        <div id="show-domain1" class="content scaffold-show" role="main">
            ...
            <f:display bean="domain1" />
            <g:form resource="${this.domain1}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.domain1}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
